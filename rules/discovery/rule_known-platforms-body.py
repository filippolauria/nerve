    ...
    def __init__(self):
        ...
        self.rule_match_string = {
            ...
            'MailDev': {
                ...
                'match': [
                    'mailDevApp',
                    'for viewing and testing emails during development'
                ],
                'title': 'Mail App'
            },
            'MediaWiki': {
            ...
            'MongoDB': {
                'app': 'MONGODB',
                'match': [
                    '<a href="/buildInfo?text=1" title="get version #, etc.',
                    '<title>mongod'
                ],
            ...
            'cPanel': {
                ...
                'match': [
                    'cPanel&reg;',
                    'sys_cpanel/images/powered_by.gif'
                ],
                'title': 'cPanel'
            },
            'Tomcat Manager': {
            ...
            'Aerospike': {
                'app': 'AEROSPIKE',
                'match': [
                    'Multicluster View is supported',
                    'Update interval should be non zero'
                ],
        ...
        for uri in COMMON_LOGIN_PATHS:
            ...
            if not response:
                ...
                for item in self.rule_match_string.values():
                    ...
                    if self.check_match(response, item['match']):
                        title = item['title']
